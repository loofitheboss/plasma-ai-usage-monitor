...
void UpdateCheckerTest::testEmitsUpdateForNewerRelease()
{
    ...
    server.setResponse(QStringLiteral("GET"),
                       ...
                       QByteArrayLiteral(R"JSON({
                           ...
                           "html_url": "https://github.com/loofitheboss/plasma-ai-usage-monitor/releases/tag/v3.9.0"
                       })JSON"));
    ...
    QCOMPARE(args.at(1).toString(),
             QStringLiteral("https://github.com/loofitheboss/plasma-ai-usage-monitor/releases/tag/v3.9.0"));
}
...
void UpdateCheckerTest::testDoesNotEmitUpdateForSameVersion()
{
    ...
    server.setResponse(QStringLiteral("GET"),
                       ...
                       QByteArrayLiteral(R"JSON({
                           "tag_name": "v3.8.1",
                           "html_url": "https://github.com/loofitheboss/plasma-ai-usage-monitor/releases/tag/v3.8.1"
                       })JSON"));
